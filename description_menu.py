...
* Отчет на один день - сотрудники организации самостоятельно выбирают дату формирования отчета о выполненной работе на один день, который сохраняется в программе XL в указанном месте хранения
* Отчет на период - сотрудники организации самостоятельно выбирают период, за который программа формирует отчет о выполненной работе, который сохраняется в программе XL в указанном месте хранения
* Отчет за месяц - сотрудники организации самостоятельно выбирают год и месяц для формирования программой стандартного отчета о выполненной работе, который сохраняется в программе XL в указанном месте хранения.
* Отчет за год - сотрудники организации самостоятельно выбирают год для формирования программой стандартного отчета о выполненной работе, который сохраняется в программе XL в указанном месте хранения.
* Сборный отчет - сотрудники организации самостоятельно выбирают период формирования нестандартного отчета о приверженности, который сохраняется в программе XL в указанном месте хранения.
...
Если вы нашли какую-то ошибку или недостаток, то можно писать свои предложения автору на почту.
'''
